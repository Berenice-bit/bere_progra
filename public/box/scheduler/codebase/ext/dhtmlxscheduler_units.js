...
Scheduler.plugin(function(e) {
    e._props = {}, e.createUnitsView = function(t, a, n, i, r, o, _) {
        function d(t) {
            return Math.round((e._correct_shift(+t, 1) - +e._min_date) / 864e5)
        }
        function s() {
            c || (c = e.xy.scale_height, e.xy.scale_height = 2 * e.xy.scale_height)
        }
        function l() {
            c && (e.xy.scale_height /= 2, c = !1)
        }
        "object" == typeof t && (n = t.list, a = t.property, i = t.size || 0, r = t.step || 1, o = t.skip_incorrect, _ = t.days || 1, t = t.name), e._props[t] = {
            map_to: a,
            options: n,
            step: r,
            position: 0,
        ...
        i > e._props[t].options.length && (e._props[t]._original_size = i, i = 0), e._props[t].size = i, e._props[t].skip_incorrect = o || !1, e.date[t + "_start"] = e.date.day_start, e.templates[t + "_date"] = function(a, n) {
            return e._props[t].days > 1 ? e.templates.week_date(a, n) : e.templates.day_date(a)
        ...
        e.templates[t + "_scale_date"] = function(a) {
            ...
            var r = e._get_unit_index(n, a),
                o = i[r],
                _ = d(a),
                s = n.size || n.options.length,
                l = e.date.add(e.getState().min_date, Math.floor(_ / s), "day");
            ...
            for (var a = e._props[t], n = a.order = {}, i = a.options, r = 0; r < i.length; r++)
                n[i[r].key] = r;
            a._original_size && 0 === a.size && (a.size = a._original_size, delete a._original_size), a.size > i.length ? (a._original_size = a.size, a.position = 0, a.size = 0) : a.size = a._original_size || a.size, e._date && e._mode == t && e.setCurrentView(e._date, e._mode)
        ...
        e[t + "_view"] = function(t) {
            ...
            t ? (a && a.days > 1 ? s() : l(), e._reset_scale()) : l()
        ...
        e._process_ignores = function(t, a, n, i, r) {
            ...
            if (_) {
                ...
                a /= d;
                for (var s = new Date(t), l = 0; l < a; l++) {
                    if (_(s))
                        for (var c = l * d, h = (l + 1) * d, u = c; u < h; u++)
                            this._ignores_detected += 1, this._ignores[u] = !0, r && a++;
                    s = e.date.add(s, i, n), e.date[n + "_start"] && (s = e.date[n + "_start"](s))
                }
            }
        };
        ...
        e._reset_scale = function() {
            ...
            if (t) {
                ...
                if (r.valueOf() >= this._min_date && r.valueOf() < this._max_date) {
                    var o = 864e5,
                        d = Math.floor((r - e._min_date) / o),
                        s = t.size || t.options.length,
                        l = d * s,
                        c = l + s;
                    for (i = l; i < c; i++)
                ...
                if (t.size && t.size < t.options.length) {
                    ...
                    t.position && (this._waiAria.headerButtonsAttributes(u, ""), e.config.rtl ? (u.className = "dhx_cal_next_button", u.style.cssText = "left:auto; right:0px;top:2px;position:absolute;") : (u.className = "dhx_cal_prev_button",
                    u.style.cssText = "left:1px;top:2px;position:absolute;"), u.innerHTML = "&nbsp;", h.firstChild.appendChild(u), u.onclick = function() {
                        e.scrollUnit(-1 * t.step)
                    }), t.position + t.size < t.options.length && (this._waiAria.headerButtonsAttributes(u, ""), u = document.createElement("div"), e.config.rtl ? (u.className = "dhx_cal_prev_button", u.style.cssText = "left:1px;top:2px;position:absolute;") : (u.className = "dhx_cal_next_button", u.style.cssText = "left:auto; right:0px;top:2px;position:absolute;"), u.innerHTML = "&nbsp;",
                    h.lastChild.appendChild(u), u.onclick = function() {
                        e.scrollUnit(t.step)
                    })
                }
            }
        ...
        e._render_x_header = function(t, a, n, i) {
            ...
            if (r.days > 1) {
                ...
                ;
                o || (o = document.createElement("div"), o.className = "dhx_second_cal_header", i.appendChild(o));
                var _ = e.xy.scale_height;
                e.xy.scale_height = Math.ceil(_ / 2), s.call(this, t, a, n, o, Math.ceil(e.xy.scale_height));
                var d = r.size || r.options.length;
                if ((t + 1) % d == 0) {
                    ...
                    var h,
                        u = this._cols[t] * d - 1;
                    h = d > 1 && this.config.rtl ? this._colsS[t - (d - 1)] - this.xy.scroll_width - 2 : d > 1 ? this._colsS[t - (d - 1)] - this.xy.scale_width - 2 : a, this.set_xy(l, u, this.xy.scale_height - 2, h, 0), l.innerHTML = this.templates[this._mode + "_second_scale_date"](new Date(c), this._mode), o.appendChild(l)
                }
                e.xy.scale_height = _
            }
        };
        ...
        e._get_event_sday = function(t) {
            ...
            if (a) {
                ...
                return Math.floor((t.end_date.valueOf() - 1 - 60 * t.end_date.getTimezoneOffset() * 1e3 - (e._min_date.valueOf() - 60 * e._min_date.getTimezoneOffset() * 1e3)) / 864e5) * (a.size || a.options.length) + a.order[t[a.map_to]] - a.position
            }
        ...
        e.locate_holder_day = function(t, a, n) {
            ...
            return n ? i(r, n) : (n = {
                start_date: t,
                end_date: t
            }, o = 0), r.days <= 1 ? 1 * (void 0 === o ? r.order[n[r.map_to]] : o) + (a ? 1 : 0) - r.position : Math.floor((n.start_date.valueOf() - e._min_date.valueOf()) / 864e5) * (r.size || r.options.length) + 1 * (void 0 === o ? r.order[n[r.map_to]] : o) + (a ? 1 : 0) - r.position
        };
        var h = e._time_order;
        ...
        e._pre_render_events_table = function(t, a) {
            ...
            if (i && i.days > 1) {
                for (var r = {}, o = 0; o < t.length; o++) {
                    ...
                    if (e.isOneDayEvent(t[o])) {
                        var d = +e.date.date_part(new Date(_.start_date));
                        r[d] || (r[d] = []), r[d].push(_)
                    } else {
                        var s = new Date(Math.min(+_.end_date, +this._max_date)),
                            l = new Date(Math.max(+_.start_date, +this._min_date));
                        for (l = e.date.day_start(l),
                        t.splice(o, 1), o--; +l < +s;) {
                            var c = this._copy_event(_);
                            c.start_date = l, c.end_date = n(c.start_date), l = e.date.add(l, 1, "day");
                ...
                for (var o in r) {
                    ...
                    (!h || g[0] > h[0]) && (h = g.slice()), t.push.apply(t, v)
                }
            ...
            for (var n in e._props) {
                var i = e._props[n];
                void 0 === a[i.map_to] && i.options[0] && (a[i.map_to] = i.options[0].key)
            }
            return !0
